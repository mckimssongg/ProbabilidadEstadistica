from StatisticalCalculator import ExtendedStatisticalCalculator
import numpy as np
...
calculator.calculate_quartile(1) # 25% de los estudiantes con rendimiento mas bajo
...
calculator.calculate_quartile(2) # 50% de los estudiantes con mejor rendimiento
...
calculator.calculate_decile(9) # 10% de los estudiantes con mejor rendimiento
